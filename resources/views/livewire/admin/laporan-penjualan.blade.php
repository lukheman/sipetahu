    ...
    <div class="row g-4 mb-4">
        ...
        <div class="col-md-6">
            <div class="modern-card text-center position-relative overflow-hidden" style="border-top: 4px solid var(--bs-success);">
                ...
                <div class="d-flex justify-content-center flex-wrap gap-3 text-muted" style="font-size: 0.85rem;">
                    @foreach($products as $product)
                        <span><i class="fas fa-circle ms-1 text-success opacity-50" style="font-size: 0.5rem; vertical-align: middle;"></i> {{ $product->nama_produk }}: <strong>{{ number_format($summary['products'][$product->id_produk]['penjualan'] ?? 0, 0, ',', '.') }}</strong></span>
                    @endforeach
                </div>
            </div>
        </div>
            ...
            <table class="table table-modern align-middle text-center">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        @endforeach
                        <td class="fw-bold text-success" style="background-color: rgba(46, 204, 113, 0.03);">{{ number_format($record->total_penjualan, 0, ',', '.') }}</td>
                    </tr>
                    @empty
                    <tr>
