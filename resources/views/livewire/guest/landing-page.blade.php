    ...
    <section class="s-tentang" id="tentang">
        <div class="tentang-inner">
            <div class="tentang-left">
                ...
                <p class="sec-body">
                    SITAHU dirancang khusus untuk <strong>Pabrik Tahu Tempe Sumber Urip</strong>. Dengan mengolah data historis penjualan menjadi prediksi masa depan yang akurat, kami membantu pemilik usaha tahu mengoptimalkan produksi dan menekan biaya.
                </p>
